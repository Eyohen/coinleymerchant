...
//       const res = await axios.post(`${URL}/api/merchants/verify-otp`, {
//         email,
//         otp: otpValue
//       }, {
//         timeout: 50000,
...
//       const res = await axios.post(`${URL}/api/merchants/resend-otp`, {
//         email
//       }, {
//         timeout: 50000,
//       });
...
//         setError('');
//         setSuccess(false); // Make sure main success is not shown
//       }
//     } catch (err) {
...
//                             className={`font-medium text-blue-600 hover:text-blue-500 ${resendDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}
//                           >
