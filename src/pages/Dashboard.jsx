...
//         const res = await axios.get(`${URL}/api/merchants/list`)
//         setList(res.data)
//     }

//     const fetchStats = async () => {
//       const res = await axios.get(`${URL}/api/merchants/stats`)
...
//   const stats = [
//     { title: "Total Revenue", value: "125,492", change: "+12.3%" },
//     { title: "Transactions", value: "99.2%", change: "+0.5%" },
//     { title: "Completed", value: "32.7%", change: "-1.2%" },
//     { title: "Pending", value: "3.2M", change: "+8.7%" }
//   ];
...
//     <>
//     {/* welcome message */}
//     <div className='px-6 py-8 rounded-2xl shadow-lg w-full border mb-12'>
//       <p className='font-bold text-3xl'>Welcome back, {user?.businessName}!</p>
...
//           <p className="text-gray-500">Transaction volume by currency will display here</p>
//         </div>
//       </div>
